...
1. На карте будет N ботов жюри, и два разных бота участников. Дополнительных требований нет. N будет равно максимальному значению, достигнутому хотя бы одной командой в раунде 3. Турнир каждый с каждым по одному бою на каждую пару. Каждая победа — 1 балл. Победа присуждается первому, доехавшему до правого края, либо (если такого нет) единственному выжившему.
2. Все ботов участников на одной карте. 10 раундов. Бот с местом P получает max(0, 4-P) баллов (т.е. первое место получает 3 балла, а 4—7 места — 0 баллов) 
